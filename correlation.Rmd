---
title: "Spatial heterogeneity of dog bite incidents and dog license"
output:
  html_document:
    code_folding: hide
...
To assess whether the spatial distribution of dog license issuance and dog bite incidents in New York City exhibits spatial heterogeneity and clustering characteristics, this study calculated both the global and local Moran's I for these variables during the research period.
...
kable(data, format = "pipe", align = "c", caption = "Implications of Local Moran's I")
```
