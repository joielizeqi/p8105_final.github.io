...
In order to further explore the relationship between dog license count and dog bites count, treat each zipcode as an observation. Then for each zipcode, the number of dog licenses and dog bite incidents from 2014 to 2022 are compared as shown in the figure below. 
