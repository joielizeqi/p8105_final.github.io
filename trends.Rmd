...
hole_trend = ggplot(daily_bites, aes(x = date_of_bite, y = bite_count)) +
  ...
  geom_smooth(se = FALSE, method = "loess", span = 1, linetype = "solid", color = "blue") + 
  labs(
...
label(dog_bites_clean$breed) = "Top 10 Breeds"
label(dog_bites_clean$gender) = "Gender"
label(dog_bites_clean$spay_neuter) = "Neuter Status"
label(dog_bites_clean$borough) = "Borough"

table1 = table1(~ breed + gender + spay_neuter + borough, 
                data = dog_bites_clean,
                overall = "Total")
